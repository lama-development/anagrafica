...
if (isset($_SESSION['username'])) {
    ...
    echo "<h1 class='welcome'>Dashboard</h1>";
    ...
    echo "<form method='post'><input type='submit' name='logout' value='Logout' class='logout-btn'></form><br>";
...
<body>
    <div class="grid">
        ...
        <form method="post" action=''>
            <div class="card">
                <div class="card-title">Cancella utente</div>
                <p>Nome<br><input type="text" name="nome" required></p>
                <p>Cognome<br><input type="text" name="cognome" required></p>
        ...
        <form method="post" action=''>
            <div class="card">
                <div class="card-title">Modifica utente</div>
    ...
    <div class="grid">
        <form method="post" action="print.php">
            <div class="card">
                <div class="card-title">Cerca utente</div>
                <p>Nome<br><input type="text" name="nome" required></p>
                <p>Cognome<br><input type="text" name="cognome" required></p>
        ...
        <form method="post" action="print.php">
            <div class="card">
                ...
                <div class="card-title">Stampa utenti</div>
        ...
        <form method="post" action="print.php">
            <div class="card">
                ...
                <p><label>Filtra per età<br>
                        <input type="number" name="eta" min="1" max="120" required>
                    </label></p>
    ...
    <div class="grid">
        <form method="post" enctype="multipart/form-data">
            <div class="card">
                <div class="card-title">Upload anagrafica</div>
